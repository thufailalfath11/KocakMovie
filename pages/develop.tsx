  ...
  <body>
    ...
    className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-95 mx-6 lg:mx-0">
          ...
          <div className="p-4 md:p-12 text-center lg:text-left" >
                ...
                <div className="imageDev"></div>

                <h1 className="text-3xl font-bold pt-8 lg:pt-0 text-black">Thufail Agung Fathi</h1>
                ...
                <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start text-black">
                    <svg className="h-4 fill-current text-blue-700 pr-4" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 20 20">
                        <path
                            d="M9 12H1v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6h-8v2H9v-2zm0-1H0V5c0-1.1.9-2 2-2h4V2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1h4a2 2 0 0 1 2 2v6h-9V9H9v2zm3-8V2H8v1h4z" />
                    </svg> Telkom University students
                </p>
                ...
                <p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
                    ...
                    </svg> My Location 7.361389°S 109.926669°E
                </p>

                <p className="pt-8 text-sm text-black">"My mission in life is not merely to survive, but to thrive."- Maya Angelou</p>
                ...
                <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                    <a className="link" href="https://www.facebook.com/profile.php?id=100018030940810" data-tippy-content="@facebook_handle">
                        <svg className="h-6 fill-current text-gray-600 hover:text-blue-700" role="img" viewBox="0 0 24 24"
                    ...
                    <a className="link" href="https://github.com/thufailalfath11" data-tippy-content="@github_handle">
                        <svg className="h-6 fill-current text-gray-600 hover:text-blue-700" role="img" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <title>GitHub</title>
                            <path
                    ...
                    <a className="link" href="https://www.instagram.com" data-tippy-content="@instagram_handle">
                        <svg className="h-6 fill-current text-gray-600 hover:text-blue-700" role="img" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a className="link" href="https://www.youtube.com/channel/UCoaKPdtSS_s1nb1D2EPFtJA" data-tippy-content="@youtube_handle">
                        <svg className="h-6 fill-current text-gray-600 hover:text-blue-700" role="img"
...
// "https://drive.google.com/uc?export=view&id=1dPQeeOL5LlnobsDdRdsNeJb8gQl4M3Om" 
...
//             src="https://drive.google.com/uc?export=view&id=1dPQeeOL5LlnobsDdRdsNeJb8gQl4M3Om" 
//             alt="John Doe"/>
//         </div>
//         <div className="p-2">
